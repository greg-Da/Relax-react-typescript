  ...
  return (
    ...
    <div className='w-3/4 h-full m-auto flex'>
      <div className=' w-full flex flex-col text-white justify-center'>
        ...
        <p className='my-4'>Afin de facilier votre navigation sur notre site, merci de selectionner un des deux boutons ci-dessous.</p>
        <div>
        <Button variant="outlineDisabled" screenWidth='xxl' onPress={() => alert("Button pressed!")}>
        Je suis un particulier
        </Button>
        <Button variant="outline" screenWidth='xxl' onPress={() => alert("Button pressed!")}>
